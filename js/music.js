$(function () {
        ...
        $(".list li").eq(0).click(function(){
            ...
            $(".music_player #img").attr({src: "http://p1.music.126.net/RDusqDuPhQz7E2SAbi5MoA==/109951162904611099.jpg?param=34y34"});
            imgplayer();
        ...
        $(".list li").eq(1).click(function(){
            ...
            $(".music_player #img").attr({src: "http://p1.music.126.net/SKujq5vqqv4KYOVFk7SiRA==/3407386538630284.jpg?param=34y34"});
            imgplayer();
            $(this).children("span").addClass("present");
            $(this).siblings().children("span").removeClass("present");
        });
